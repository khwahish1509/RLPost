...
- [ ] **S3c — the remaining half of the skill:** rewards/curriculum that make trap-keeping and stale-value retention expensive enough to beat compression alone (abstention is currently a free 0.00 for everyone — the signal exists but is being swamped); then the cross-domain rung and a real-reader (grok) spot-check.
