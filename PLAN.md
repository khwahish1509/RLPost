...
- [ ] **S3b — force true selection:** tighter cap + longer streams so copy-everything overflows catastrophically (the S2 lesson at the language level); then the cross-domain rung and a real-reader (grok) spot-check.
